...
// BasicTabbedPaneUI methods
    ...
    protected void navigateSelectedTab(int direction) {
        ...
        int tabCount = tabPane.getTabCount();
        boolean leftToRight = GraphicsUtils.isLeftToRight(tabPane);
    ...
    private static class Actions extends UIAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            BasicTabbedPaneUI ui = (BasicTabbedPaneUI) GraphicsUtils.
    ...
    private class CroppedEdge extends JPanel implements UIResource {
        ...
        protected void paintComponent(Graphics g) {
            ...
            if (isParamsSet() && g instanceof Graphics2D) {
                ...
                int start = shape.getBounds().x - 20 >= 0 
                        ? shape.getBounds().x - 20
                        : 0 ;
                
                int end = shape.getBounds().x + 5;
                
                g2.setPaint(new GradientPaint(start, 0, CoalPainter.Transparent, end, 0, new Color(0,0,0,200)));
                g2.fillRect(start, 0, end, getHeight());
            }
        }
    }
    
    private static class GraphicsUtils {
